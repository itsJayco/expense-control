...
namespace Backend.Api.Migrations
{
    ...
    [Migration("20251122152334_AddExpenseDetailBudget")]
    partial class AddExpenseDetailBudget
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Backend.Domain.Entities.ExpenseDetail", b =>
                {
            ...
            modelBuilder.Entity("Backend.Domain.Entities.ExpenseHeader", b =>
                {
                    b.Property<int>("ExpenseHeaderId")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");

                    SqlServerPropertyBuilderExtensions.UseIdentityColumn(b.Property<int>("ExpenseHeaderId"));
            ...
            modelBuilder.Entity("Backend.Domain.Entities.ExpenseDetail", b =>
                {
                    b.HasOne("Backend.Domain.Entities.Budget", null)
                        .WithMany()
                        .HasForeignKey("BudgetId")
                        .OnDelete(DeleteBehavior.Restrict)
                        .IsRequired();
                    ...
                    b.HasOne("Backend.Domain.Entities.ExpenseHeader", "ExpenseHeader")
                        .WithMany("Details")
